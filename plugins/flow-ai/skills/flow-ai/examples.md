...
```bash
curl -s -A "flow-ai/0.7.0" --get "${FLOW_API_URL:-https://app.flow.bio/api}/pipelines" | \
...
```bash
curl -s -A "flow-ai/0.7.0" --get "${FLOW_API_URL:-https://app.flow.bio/api}/samples/search" \
...
```bash
curl -s -A "flow-ai/0.7.0" --get "${FLOW_API_URL:-https://app.flow.bio/api}/projects/search" \
...
```bash
curl -s -A "flow-ai/0.7.0" --get "${FLOW_API_URL:-https://app.flow.bio/api}/samples/12345/executions" \
...
```bash
curl -s -A "flow-ai/0.7.0" --get "${FLOW_API_URL:-https://app.flow.bio/api}/samples/12345/data" \
  --data-urlencode "count=100" | \
...
```bash
curl -s -A "flow-ai/0.7.0" -o sample.fastq.gz \
...
```bash
curl -s -A "flow-ai/0.7.0" --get "${FLOW_API_URL:-https://app.flow.bio/api}/data/67890/contents" | \
...
```bash
curl -s -A "flow-ai/0.7.0" --get "${FLOW_API_URL:-https://app.flow.bio/api}/samples/12345" | \
...
```bash
curl -s -A "flow-ai/0.7.0" --get "${FLOW_API_URL:-https://app.flow.bio/api}/projects/4567" | \
...
```bash
curl -s -A "flow-ai/0.7.0" --get "${FLOW_API_URL:-https://app.flow.bio/api}/data/67890" | \
...
HUMAN_ID=$(curl -s -A "flow-ai/0.7.0" \
...
PROJECT_ID=$(curl -s -A "flow-ai/0.7.0" \
